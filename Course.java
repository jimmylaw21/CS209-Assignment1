...
public class Course {
  ...
  public Course(String institution, String courseNumber, LocalDate launchDate, String courseTitle,
          List<String> instructors, String courseSubject, int year,
          boolean hasHonorCodeCert, int participantsCount, int auditedCount,
          int certifiedCount, double auditedPercent, double certifiedPercent,
          double certifiedPercent50, double videoPlayedPercent, double forumPostedPercent,
          double gradeHigherThanZeroPercent, double totalCourseHours,
          double medianHoursCertification, double medianAge, double malePercent,
          double femalePercent, double bachelorsOrHigherPercent) {
